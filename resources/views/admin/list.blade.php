                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$ad->alamat}}</td>
                      <td>
                        <button type="button" class="btn btn-outline-secondary btn-sm ubah" data-toggle="modal" data-target="#ubahModal" data-id_admin="{{$ad->id_admin}}" data-nama="{{$ad->nama}}" data-email="{{$ad->email}}" data-alamat="{{$ad->alamat}}"><i class="fas fa-edit"></i> Ubah</button> 
                        <a class="konfirmasi" href="/hapusAdmin/{{$ad->id_admin}}"><button type="button" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i> Hapus</button></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
