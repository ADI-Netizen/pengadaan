                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="{{asset(Storage::url($peng['laporan']))}}" class="btn btn-outline-success" target="_blank"><i class="fa fa-eye"></i> Lihat Laporan</a>
                        @endif
                      </td>
                      <td>
                        @if($peng['status_pengajuan'] == 2)
                        Peninjauan
                        <hr>
                        <a href="/tolakLaporan/{{$peng['id_laporan']}}" class="btn btn-outline-danger btn-sm proses"><i class="fa fa-times"></i> Ditolak</a>
                        <a href="/selesaiPengajuan/{{$peng['id_pengajuan']}}" class="btn btn-outline-success btn-sm proses"><i class="fa fa-check"></i> Diterima</a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
