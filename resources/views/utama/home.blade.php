      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            ...
            @else
            <a href="/listSupp" class="btn-get-started scrollto">Ajukan Sekarang</a>
            @endif
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Ketentuan</h2>
          <p>Untuk dapat melakukan pengajuan barang dan jasa, Peserta harus memiliki kualifikasi sebagai berikut :</p>
        </div>
        ...
        <div class="row">
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p>Bagi peserta yang ingin melakukan pengajuan wajib terdaftar atau memiliki izin usaha</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <p>Bagi Anda yang memiliki usaha sudah lebih dari tiga tahun dapat melakukan pengajuan</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p>Usaha Anda wajib berbadan hukum minimal CV dan sudah terdaftar sekurang-kurangnya 3 tahun</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          <div class="col-lg-9 text-center text-lg-start">
            ...
            <p> Anda dapat mendaftarkan usaha Anda agar dapat melakukan pengajuan dari setiap sektor yang diperlukan</p>
          </div>
          <div class="col-lg-3 cta-btn-container text-center">
            @if($token == "kosong")
            <a class="cta-btn align-middle" href="/registrasi">Daftar</a>
            @else
            <a class="cta-btn align-middle" href="/listSupp">Ajukan</a>
            @endif
          </div>
        </div>
